...
//     // In a real app, you would get this from an authentication session
//     const userId = "user123"

//     // Check if recipe already exists for this user
//     const existingRecipe = await prisma.recipe.findFirst({
//       where: {
//         spoonacularId: body.recipeId,
//         userId: userId,
//       },
//     })

//     if (existingRecipe) {
//       return NextResponse.json({ message: "Recipe already saved", recipe: existingRecipe }, { status: 200 })
//     }

//     // Fetch recipe details from Spoonacular API
//     // In a real implementation, you would call the Spoonacular API here
